...
Skills live in `.agents/skills/`: `cut-jetson-release` tags, validates and publishes a product release; `jetson-hil` drives a bench Jetson (DP712 power, debug UART, USB flash, SSH).
